  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
          <div class="col-xs-12">
          	<table id="projHealthPopupTb" class="table table-hover common-table table-sm table-striped table-bordered dt-responsive nowrap" style="width: 100%">
				<thead>
					<tr>
						<th>Health</th>
						<th>Description</th>
      ...
      <div class="modal-footer">
        <button id="okPHPbtn" type="button" class="btn btn-default">Ok</button>
        <button id="closePHP" type="button" class="btn btn-default" data-dismiss="modal">Close</button>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
